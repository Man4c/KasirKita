# Graph Report - KasirKita  (2026-09-03)

## Corpus Check
- 436 files · ~595,276 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5014 nodes · 11330 edges · 335 communities (285 shown, 50 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 339 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3021b24e`
...
Cohesion: 0.03
Nodes (136): applyGlobalBarLabelState(), applyPlaceholderSizingStyles(), averageRgb01(), beginEditPin(), bindEditBadgeProxy(), bufferToBase64(), buildAnnotationsForCapture(), buildCollapsible() (+128 more)
...
Cohesion: 0.13
Nodes (18): App(), MainApp(), styles, styles, ChangePasswordModal(), styles, styles, UserProfileModal() (+10 more)
...
Cohesion: 0.09
Nodes (44): agentHasWorkInFlight(), agentStatusText(), attachSteerFocusDebug(), attachSteerFocusGuard(), barPaletteForTheme(), brandMarkSvg(), buildDesignHeader(), buildParamsPanel() (+36 more)
...
Cohesion: 0.13
Nodes (19): checkPageTypography(), firstOverusedGoogleFont(), checkStaticPageTypography(), checkElementItalicSerif(), checkElementItalicSerifDOM(), checkItalicSerif(), checkPageTypography(), checkTypography() (+11 more)
...
Cohesion: 0.13
Nodes (19): checkElementHeroEyebrow(), checkElementOversizedH1(), checkElementOversizedH1DOM(), checkElementQuality(), checkKickerAboveHeading(), checkKickerAboveHeadingDOM(), checkKickerAboveHeadingFromDoc(), checkNumberedSectionLabels() (+11 more)
...
Cohesion: 0.03
Nodes (148): borderColorsFromStyle(), borderWidthsFromStyle(), checkBorders(), checkClippedOverflow(), checkColors(), checkCreamPalette(), checkEdgeFlushCardsDOM(), checkElementAIPaletteDOM() (+140 more)
...
Cohesion: 0.09
Nodes (22): CustomerPickerModal(), styles, LandscapeRegisterPanel(), styles, PosCartModal(), styles, PosCheckoutView(), styles (+14 more)
...
Cohesion: 0.11
Nodes (18): PaymentSuccessModal(), styles, PosReceiptModal(), styles, ReceiptView(), PrinterGuideModal(), styles, PrinterSettingsModal() (+10 more)
...
- **Why does `el()` connect `el` to `live-browser.js`, `design-system.mjs`, `index.mjs`, `detect-text.mjs`, `GENERIC_FONTS`, `initPageChat`, `initGlobalBar`, `Request`, `font-fingerprint.mjs`, `detect-antipatterns-browser.js`, `colorFunctionToRgb`, `roots.mjs`, `openTunePopover`, `collectBrowserFindings`, `svelte-ast.mjs`, `accept-css.mjs`, `applyEditing`, `session-store.mjs`, `index.mjs`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `v()` connect `modern-screenshot.umd.js` to `captureElementToBlob`, `font-match.mjs`, `design-parser.mjs`, `accept-css.mjs`, `live-browser.js`, `index.mjs`, `applyEditing`, `resolveLiveInjectionAnchor`, `initGlobalBar`, `GENERIC_FONTS`, `checkElementRadialSpotlightDOM`, `collectBrowserFindings`, `TransactionItem.php`?**
