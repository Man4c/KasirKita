...
## Corpus Check
- 481 files · ~666,882 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5232 nodes · 11777 edges · 351 communities (300 shown, 51 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 362 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4230a059`
...
## Communities (351 total, 51 thin omitted)
...
Cohesion: 0.12
Nodes (21): checkBorders(), checkEdgeFlushCardsDOM(), checkElementBlinkingCursorDOM(), checkElementBorders(), checkElementBordersDOM(), checkElementPseudoStripeDOM(), checkElementTextOverflowDOM(), checkFirstViewportColumnOverflowDOM() (+13 more)
...
Cohesion: 0.25
Nodes (16): binarize(), _debugLines(), findLines(), fingerprint(), GROSS_STD, HQ, isolateDominant(), lineMetrics() (+8 more)
...
Cohesion: 0.24
Nodes (14): checkElementColors(), checkElementGlowDOM(), checkElementHoverContrast(), checkHoverContrast(), compositeColorOver(), compositeGradientStops(), extractColorFunctionTokens(), isNoPaintColorValue() (+6 more)
...
Cohesion: 0.11
Nodes (26): browserFindingsFromMap(), checkEdgeFlushCardsDOM(), checkElementBlinkingCursorDOM(), checkElementTextOverflowDOM(), checkFirstViewportColumnOverflowDOM(), checkHeadingRhythmDOM(), checkRepeatedContainerTextDOM(), checkRepeatedContainerTextFromDoc() (+18 more)
...
Cohesion: 0.04
Nodes (117): ANIMATION_VALUE_KEYWORDS, borderColorsFromStyle(), borderWidthsFromStyle(), buildHtmlPatternCorpora(), checkClippedOverflow(), checkElementClippedOverflow(), checkElementClippedOverflowDOM(), checkElementGptBorderShadow() (+109 more)
...
Cohesion: 0.24
Nodes (10): checkElementMotion(), checkElementMotionDOM(), checkLayout(), checkMotion(), checkPageLayout(), isCardLike(), isCardLikeDOM(), isCardLikeFromProps() (+2 more)
...
Cohesion: 0.07
Nodes (37): App(), MainApp(), styles, CategoryCardItem, styles, CategoryFormModal(), styles, CustomerCardItem (+29 more)
...
Cohesion: 0.10
Nodes (36): checkBorders(), checkCreamPalette(), checkElementBorders(), checkElementBordersDOM(), checkElementColorsDOM(), checkElementHeroEyebrowDOM(), checkElementPseudoStripeDOM(), clamp01() (+28 more)
...
Cohesion: 0.08
Nodes (35): mergeDesignSystemFindings(), checkPageTypography(), firstOverusedGoogleFont(), runTextContentAnalyzers(), checkStaticPageTypography(), detectHtml(), STATIC_ELEMENT_RULES, checkCreamPalette() (+27 more)
...
Cohesion: 0.16
Nodes (13): DashboardActionHub(), styles, ProductBarcodeScannerModal(), styles, ProductCardItem, styles, ProductFormModal(), styles (+5 more)
...
Cohesion: 0.06
Nodes (37): DashboardDetailModal(), styles, DashboardMetricsGrid(), styles, RecentTransactionsSection(), styles, SalesTrendChart(), styles (+29 more)

### Community 306 - "Visualize: Direction Comps & Asset Production"
Cohesion: 0.21
Nodes (8): styles, SupplierCardItem, POPULAR_BANKS, styles, SupplierFormModal(), formatRp(), styles, supplierService
...
Cohesion: 0.09
Nodes (42): buildHtmlPatternCorpora(), checkColors(), checkElementAIPaletteDOM(), checkElementGlow(), checkGlow(), checkHtmlPatterns(), checkRadialSpotlight(), collectCssCustomProps() (+34 more)
...
Cohesion: 0.27
Nodes (7): styles, UnitCardItem, COMMON_PRESETS, styles, UnitFormModal(), styles, unitService
...
Cohesion: 0.50
Nodes (4): plugins, expo-audio, expo-secure-store, @react-native-community/datetimepicker
...
Cohesion: 0.11
Nodes (26): checkElementHeroEyebrow(), checkElementIconTile(), checkElementIconTileDOM(), checkHeroEyebrow(), checkIconTile(), checkKickerAboveHeading(), checkKickerAboveHeadingDOM(), checkKickerAboveHeadingFromDoc() (+18 more)
...
## Knowledge Gaps
- **1104 isolated node(s):** `HERE`, `STATE_PATH`, `MOCKS_DIR`, `HERO_REPRO`, `GATES` (+1099 more)
...
- **Why does `el()` connect `el` to `live-browser.js`, `design-system.mjs`, `initGlobalBar`, `accept-css.mjs`, `index.mjs`, `Request`, `doctor.md`, `detect-antipatterns-browser.js`, `applyEditing`, `initGlobalBar`, `collectBrowserFindings`, `checkHeroEyebrow`, `surface-briefs.mjs`, `tag-strategy.mjs`, `insert-ui.mjs`, `svelte-ast.mjs`, `initPageChat`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `v()` connect `modern-screenshot.umd.js` to `font-match.mjs`, `captureElementToBlob`, `design-parser.mjs`, `initGlobalBar`, `accept-css.mjs`, `index.mjs`, `live-browser.js`, `applyEditing`, `initGlobalBar`, `App.jsx`, `checkElementRadialSpotlightDOM`, `collectBrowserFindings`, `tag-strategy.mjs`, `TransactionItem.php`?**
