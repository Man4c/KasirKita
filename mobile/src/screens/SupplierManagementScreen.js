    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        {isOffline && (
          <View style={styles.offlineBanner}>
            <WifiOff size={14} color="#fb7185" style={{ flexShrink: 0 }} />
          ...
          {statusChips.map((chip) => {
            ...
            return (
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                {isSelected && <CheckCircle2 size={12} color="#fb7185" style={{ flexShrink: 0 }} />}
                <Text
                  style={[
      ...
      {isOwner && (
        <TouchableOpacity
          ...
          hitSlop={{ top: 8, bottom: 8, left: 8, right: 8 }}
        >
          <Plus size={18} color="#ffffff" style={{ flexShrink: 0 }} />
